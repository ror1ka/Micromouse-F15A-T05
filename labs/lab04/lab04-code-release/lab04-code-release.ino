...
mtrn3100::EncoderOdometry encoder_odometry(16, 75); //TASK1 TODO: IDENTIFY THE WHEEL RADIUS AND AXLE LENGTH
...
//THE DELAY IS REQUIRED OTHERWISE THE ENCODER DIFFERENCE IS TOO SMALL
    ...
    // IMU is bad
    // Wheel friciton/imperfect movement can cause wheel to not rotate completely as intended
    // Wheel could be not straight, offset.
